...
#ifdef ISMACrypt
u32 MP4SampleEntryProtos[] = { MP4MPEGSampleEntryAtomType, MP4VisualSampleEntryAtomType, MP4AudioSampleEntryAtomType, MP4EncAudioSampleEntryAtomType, MP4EncVisualSampleEntryAtomType, MP4XMLMetaSampleEntryAtomType, MP4TextMetaSampleEntryAtomType, MP4AMRSampleEntryAtomType, MP4AWBSampleEntryAtomType, MP4AMRWPSampleEntryAtomType, MP4H263SampleEntryAtomType, MP4RestrictedVideoSampleEntryAtomType, 0 };
#else
u32 MP4SampleEntryProtos[] = { MP4MPEGSampleEntryAtomType, MP4VisualSampleEntryAtomType, MP4AudioSampleEntryAtomType, MP4XMLMetaSampleEntryAtomType, MP4TextMetaSampleEntryAtomType, MP4AMRSampleEntryAtomType, MP4AWBSampleEntryAtomType, MP4AMRWPSampleEntryAtomType, MP4H263SampleEntryAtomType, MP4RestrictedVideoSampleEntryAtomType, 0 };
#endif
...
{
	return MP4NewSampleDescriptionWithOCRAssociation( theTrack, sampleDescriptionH, dataReferenceIndex, objectTypeIndication, streamType, decoderBufferSize, maxBitrate, avgBitrate, decoderSpecificInfoH, 0 );
}
    ...
    u32                                             theOCRESID )
{
	...
	if( err )
		goto bail;
	err = MP4CreateDecoderConfigDescriptor( MP4DecoderConfigDescriptorTag, 0, 0, (MP4DescriptorPtr *)&config );
	if( err )
		goto bail;
...
MP4_EXTERN( MP4Err )
ISOAddBitrateToSampleDescription( MP4Handle sampleEntryH, u8 is_3GPP, u32 buffersizeDB, u32 maxBitrate, u32 avgBitrate )
{
	MP4Err                       err = MP4NoErr;
	MP4GenericSampleEntryAtomPtr entry = NULL;
...
MP4_EXTERN( MP4Err )
ISONewH263SampleDescription( MP4Track theTrack,
    MP4Handle                         sampleDescriptionH,
    u32                               dataReferenceIndex,
    u32                               vendor,
    u8                                decoder_version,
...
MP4_EXTERN( MP4Err )
ISONewAMRSampleDescription( MP4Track theTrack,
    MP4Handle                        sampleDescriptionH,
    u32                              dataReferenceIndex,
    u8                               is_WB,
    u32                              vendor,
...
MP4_EXTERN( MP4Err )
ISONewAMRWPSampleDescription( MP4Track theTrack,
    MP4Handle                          sampleDescriptionH,
    u32                                dataReferenceIndex,
    u32                                vendor,
    u8                                 decoder_version )
...
MP4_EXTERN( MP4Err )
ISONewAVCSampleDescription( MP4Track theTrack,
    MP4Handle                        sampleDescriptionH,
    u32                              dataReferenceIndex,
    u32                              length_size,
    MP4Handle                        first_sps,
    ...
    MP4Handle                        first_spsext )
{
	...
	if( err )
		goto bail; /* PPS ID */
	if( ( config->profile == 100 ) || ( config->profile == 110 ) || ( config->profile == 122 ) || ( config->profile == 144 ) ) {
		y = read_golomb_uev( bb, &err );
		if( err )
			goto bail;
                                                ...
                                                MP4Handle ps, u32 where )
{
	...
	if( entry->type != ISOAVCSampleEntryAtomType )
		BAILWITHERROR( MP4BadParamErr );
...
MP4_EXTERN( MP4Err )
ISOGetAVCSampleDescription( MP4Handle sampleEntryH,
    u32 *                             dataReferenceIndex,
    u32 *                             length_size,
    u32 *                             sps_count,
    u32 *                             pps_count,
...
MP4_EXTERN( MP4Err )
ISOGetRESVOriginalFormat( MP4Handle sampleEntryH,
    u32 *                           outOrigFmt )
{
	MP4Err                               err = MP4NoErr;
...
MP4_EXTERN( MP4Err )
ISONewHEVCSampleDescription( MP4Track theTrack,
    MP4Handle                         sampleDescriptionH,
    u32                               dataReferenceIndex,
    u32                               length_size,
    MP4Handle                         first_sps,
