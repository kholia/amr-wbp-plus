...
static MP4Err setSampleDependency( struct MP4SampleDependencyAtom *self, s32 sample_index, MP4Handle dependencies )
{
	MP4Err err;
	u32    i;
	u8 *   p;
...
static MP4Err getSampleDependency( struct MP4SampleDependencyAtom *self, u32 sampleNumber, u8 *dependency )
{
	MP4Err err;
