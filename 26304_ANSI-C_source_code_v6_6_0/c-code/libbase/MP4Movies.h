...
MP4_EXTERN( MP4Err )
MP4NewMovie( MP4Movie *outMovie, u32 initialODID, u8 OD_profileAndLevel, u8 scene_profileAndLevel, u8 audio_profileAndLevel, u8 visual_profileAndLevel, u8 graphics_profileAndLevel );
...
MP4_EXTERN( MP4Err )
MP4GetElementaryStreamPacket( MP4Media theMedia, MP4Handle outSample, u32 *outSize, u32 sequenceNumber, u64 desiredTime, u64 *outActualTime, u64 *outDuration );
...
MP4_EXTERN( MP4Err )
ISONewGeneralSampleDescription( MP4Track theTrack,
    MP4Handle                            sampleDescriptionH,
    u32                                  dataReferenceIndex,
    u32                                  sampleEntryType,
...
MP4_EXTERN( MP4Err )
ISONewXMLMetaDataSampleDescription( MP4Track theTrack,
    MP4Handle                                sampleDescriptionH,
    u32                                      dataReferenceIndex,
...
MP4_EXTERN( MP4Err )
ISONewTextMetaDataSampleDescription( MP4Track theTrack,
    MP4Handle                                 sampleDescriptionH,
    u32                                       dataReferenceIndex,
    char *                                    content_encoding,
    char *                                    mime_format );
...
MP4_EXTERN( MP4Err )
MP4TrackReaderGetNextAccessUnit( MP4TrackReader theReader, MP4Handle outAccessUnit, u32 *outSize, u32 *outSampleFlags, s32 *outCTS, s32 *outDTS );
...
MP4_EXTERN( MP4Err )
MP4NewMovieExt( MP4Movie *outMovie, u32 initialODID, u8 OD_profileAndLevel, u8 scene_profileAndLevel, u8 audio_profileAndLevel, u8 visual_profileAndLevel, u8 graphics_profileAndLevel, char *url, u8 IsExchangeFile );
...
MP4_EXTERN( MP4Err )
ISOSetCompositonToDecodePropertiesForFragments( MP4Movie theMovie, u32 trackID, s32 compositionToDTSShift, s32 leastDecodeToDisplayDelta, s32 greatestDecodeToDisplayDelta, s32 compositionStartTime, s32 compositionEndTime );
...
#ifdef ISMACrypt
MP4_EXTERN( MP4Err )
ISMATransformSampleEntry( u32 newTrackFlags, MP4Handle insampleEntryH, u8 selective_encryption, u8 key_indicator_length, u8 IV_length, char *kms_URL, MP4Handle outsampleEntryH );

MP4_EXTERN( MP4Err )
ISMAUnTransformSampleEntry( MP4Handle insampleEntryH,
...
MP4_EXTERN( MP4Err )
ISMATransformSampleEntrySalt( u32 newTrackFlags, MP4Handle insampleEntryH, u8 selective_encryption, u8 key_indicator_length, u8 IV_length, char *kms_URL, u64 salt, MP4Handle outsampleEntryH );

MP4_EXTERN( MP4Err )
ISMAUnTransformSampleEntrySalt( MP4Handle insampleEntryH,
    u8 *                                  selective_encryption,
    u8 *                                  key_indicator_length,
    u8 *                                  IV_length,
    char **                               kms_URL,
