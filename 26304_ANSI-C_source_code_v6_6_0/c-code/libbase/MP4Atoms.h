...
typedef struct MP4MediaAtom {
	...
	MP4Err ( *addSampleReference )( struct MP4MediaAtom *self, u64 dataOffset, u32 sampleCount, MP4Handle durationsH, MP4Handle sizesH, MP4Handle sampleEntryH, MP4Handle decodingOffsetsH, MP4Handle syncSamplesH, MP4Handle padsH );
	MP4Err ( *addSamples )( struct MP4MediaAtom *self, MP4Handle sampleH, u32 sampleCount, MP4Handle durationsH, MP4Handle sizesH, MP4Handle sampleEntryH, MP4Handle decodingOffsetsH, MP4Handle syncSamplesH, MP4Handle padsH );
...
#define COMMON_MINF_ATOM_FIELDS                                                                                                                                                                                                                    \
	MP4Err ( *addSampleReference )( struct MP4MediaInformationAtom * self, u64 dataOffset, u32 sampleCount, MP4Handle durationsH, MP4Handle sizesH, MP4Handle sampleEntryH, MP4Handle decodingOffsetsH, MP4Handle syncSamplesH, MP4Handle padsH ); \
	MP4Err ( *addSamples )( struct MP4MediaInformationAtom * self, MP4Handle sampleH, u32 sampleCount, MP4Handle durationsH, MP4Handle sizesH, MP4Handle sampleEntryH, MP4Handle decodingOffsetsH, MP4Handle syncSamplesH, MP4Handle padsH );      \
...
typedef struct MP4SampleTableAtom {
	...
	MP4Err ( *getSampleAuxiliaryInformation )( struct MP4SampleTableAtom *self, u8 isUsingAuxInfoPropertiesFlag, u32 aux_info_type, u32 aux_info_type_parameter, MP4SampleAuxiliaryInformationSizesAtomPtr *saizOut, MP4SampleAuxiliaryInformationOffsetsAtomPtr *saioOut );
...
typedef struct MP4TimeToSampleAtom {
	...
	MP4Err ( *findSamples )( MP4AtomPtr self, u64 desiredTime, s64 *outPriorSample, s64 *outExactSample, s64 *outNextSample, u32 *outSampleNumber, s32 *outSampleDuration );
...
typedef struct MP4SampleToChunkAtom {
	...
	MP4Err ( *mdatMoved )( struct MP4SampleToChunkAtom *self, u64 mdatBase, u64 mdatEnd, s32 mdatOffset, struct MP4SampleDescriptionAtom *stsd, struct MP4DataReferenceAtom *dref, struct MP4ChunkOffsetAtom *stco );
	MP4LinkedList entryList;
...
typedef struct MP4SubSampleInformationAtom {
	MP4_FULL_ATOM
	MP4Err ( *addEntry )( struct MP4SubSampleInformationAtom *self, u32 sample_delta, u32 subsample_count, MP4Handle subsample_size_array, MP4Handle subsample_priority_array, MP4Handle subsample_discardable_array );
	u32   entry_count;
	u32 * sample_delta;
	u32 * subsample_count;
	u32 **subsample_size;
...
typedef struct MP4EditListAtom {
	...
	MP4Err ( *getTimeAndRate )( MP4AtomPtr self, u64 movieTime, u32 movieTimeScale, u32 mediaTimeScale, s64 *outMediaTime, u32 *outMediaRate, u64 *outPriorSegmentEndTime, u64 *outNextSegmentBeginTime );
...
typedef struct MP4MovieExtendsAtom {
	...
	MP4Err ( *setCompositionToDecodeProperties )( struct MP4MovieExtendsAtom *self, u32 trackID, s32 compositionToDTSShift, s32 leastDecodeToDisplayDelta, s32 greatestDecodeToDisplayDelta, s32 compositionStartTime, s32 compositionEndTime );
...
typedef struct MP4TrackFragmentAtom {
	...
	MP4Err ( *getSampleAuxiliaryInfoFromTrackFragment )( struct MP4TrackFragmentAtom *self, u8 isUsingAuxInfoPropertiesFlag, u32 aux_info_type, u32 aux_info_type_parameter, MP4SampleAuxiliaryInformationSizesAtomPtr *saizOut, MP4SampleAuxiliaryInformationOffsetsAtomPtr *saioOut );
