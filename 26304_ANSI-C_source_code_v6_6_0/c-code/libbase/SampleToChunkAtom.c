...
static MP4Err mdatMoved( struct MP4SampleToChunkAtom *self, u64 mdatBase, u64 mdatEnd, s32 mdatOffset, struct MP4SampleDescriptionAtom *stsd, struct MP4DataReferenceAtom *dref, struct MP4ChunkOffsetAtom *stco )
{
	MP4Err err;
	u32    i;
	u32    entryCount;
...
static MP4Err lookupSample( MP4AtomPtr s, u32 sampleNumber, u32 *outChunkNumber, u32 *outSampleDescriptionIndex, u32 *outFirstSampleNumberInChunk )
{
	MP4Err       err;
	u32          i;
	u32          entryCount;
