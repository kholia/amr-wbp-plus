...
static MP4Err addEntry( MP4AtomPtr s, u32 sample_delta, u32 subsample_count, MP4Handle subsample_size_array, MP4Handle subsample_priority_array, MP4Handle subsample_discardable_array )
{
	MP4Err                         err;
	MP4SubSampleInformationAtomPtr self;
	u32                            i;
