...
MP4_EXTERN( MP4Err )
MP4GetElementaryStreamPacket( MP4Media theMedia, MP4Handle outPacket, u32 *outSize, u32 sequenceNumber, u64 desiredDecodingTime, u64 *outActualTime, u64 *outDuration )
{
	MP4Err    err;
	MP4Handle sampleH;
	u32       sampleSize;
	...
	err = MP4GetMediaSample( theMedia, sampleH, &sampleSize, desiredDecodingTime, outActualTime, &sampleCTS, outDuration, NULL, NULL, &sampleFlags );
	if( err )
		goto bail;
