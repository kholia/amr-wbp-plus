...
Word32 E_GAIN_open_loop_search( Float32 *wsp, Word32 L_min, Word32 L_max, Word32 nFrame, Word32 L_0, Float32 *gain, Float32 *mem, Float32 hp_old_wsp[], UWord8 weight_flg );
...
Word32 E_GAIN_voice_factor( Word16 exc[], Word16 Q_exc, Word16 gain_pit, Word16 code[], Word16 gain_code );
